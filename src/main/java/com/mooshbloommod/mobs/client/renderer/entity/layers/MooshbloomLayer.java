package com.mooshbloommod.mobs.client.renderer.entity.layers;
...
@OnlyIn(Dist.CLIENT)
public class MooshbloomLayer<T extends MooshbloomEntity> extends LayerRenderer<T, CowModel<T>> {

    public MooshbloomLayer(IEntityRenderer<T, CowModel<T>> rendererIn) {
        super(rendererIn);
    }
